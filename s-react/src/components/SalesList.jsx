...
export default function SalesSummary() {
  ...
  const [mode, setMode] = useState("week"); // 週 / 月 / 年
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => console.error("売上取得エラー:", err));
  }, []);
          ...
          {employeesWithTotals.map((emp) => (
            <tr key={emp.id} className="hover:bg-gray-100">
              ...
              <td className="border p-2">
                {personalTotals[emp.id].toLocaleString()} 円
              </td>
              ...
              <td className="border p-2 space-x-2">
                <button
                  ...
                  onClick={() => navigate(`/sales/${emp.id}/edit`)}
                >
                  編集
                </button>
                ...
                <button
                  ...
                  onClick={() => navigate(`/sales/${emp.id}/delete`)}
                >
                  削除
                </button>
              </td>
